...
function Flying (){
    ...
    useEffect(() =>  {
        ...
        try{
            ...
            const get = await axios.get("https://pokeapi.co/api/v2/type/flying/") 
            const res = get.data
            settypeinfo(res)
...
{typeinfo && (
    <div className="sm:flex sm:justify-center items-center">
        <div className=" align-center mt-8 sm:overflow-y-auto bg-white p-3 border-black border-8 rounded-2xl sm:w-[800px] sm:px-auto lg:w-[800px] sm:h-[1100px]">
            <p className="text-center font-extrabold mb-10 text-5xl">Flying Pokemons</p>
            ...
            <div className="sm:flex sm:justify-center">
                <div className="mt-12 bg-white   rounded-2xl  xl:h-[1100px] w-[680px]">
                    ...
                    <p className="text-center font-extrabold mb-10 text-5xl mt-8">Flying Moves Pokemons</p>
